...
- لو مش موجود أصلاً: احكيله يفضّل يضيف فقرة ملخص مهني أو هدف وظيفي يكتب فيها أبرز إنجازاته و ليش هو مناسب للوظيفة.
...
- لو مقيّم اللغة بنجوم أو أشرطة تقدم: احكيله الصح تكتب المستوى بالكلمات زي Advanced أو Good مش رسومات نجوم ولا أشرطة.
...
- لو في قالب جرافيكي رسومي أو أعمدة أو ألوان تصميم أو جداول: احكيله التصميم عندك مبهرج و الصح يكون رسمي أكثر بلون أو لونين على الأكثر و تنكتب السيرة على الورد. و اشرح إنو لو الشركة اللي بتقدم عليها (بتقدمي عليها للأنثى) بتستخدم برامج فلترة طلبات فالسيرة المكتوبة على الورد بتتفلتر صح. ممنوع تصف تفاصيل التصميم (زي عمود جانبي أخضر أو ألوان متعددة) اكتفِ بكلمة مبهرج.
...
- لو الملف صورة محوّلة لـ PDF مش نص قابل للقراءة: احكيله أهم مشكلة إنو الملف عبارة عن صورة مش ملف نص. لازم يكون نص فعلي عشان يقدروا ينسخوا و يقروا محتواه بسهولة بدل ما يكون مجرد صورة."""

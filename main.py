...
- لو في أيقونات بمعلومات الاتصال أو بأي مكان بالسيرة: احكيله ما بنفع تحط أيقونات بالسيرة للذكر أو ما بنفع تحطي أيقونات بالسيرة للأنثى لأنو أغلب الشركات بتستخدم أنظمة ATS.
...
- لو في قالب جرافيكي رسومي أو أعمدة أو ألوان تصميم أو جداول: احكيله التصميم مرفوض للأسف لأنو أغلب الشركات بتستخدم برامج فلترة آلية للطلبات فالصح تنكتب السيرة على الورد بقالب بسيط و واضح و رسمي. ممنوع تصف تفاصيل التصميم (زي عمود جانبي أخضر أو ألوان متعددة).
